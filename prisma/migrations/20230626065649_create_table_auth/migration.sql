...
CREATE TABLE `accounts` (
    ...
    UNIQUE INDEX `accounts_provider_id_provider_account_id_key`(`provider_id`, `provider_account_id`),
    PRIMARY KEY (`id`)
...
CREATE TABLE `verification_requests` (
    ...
    UNIQUE INDEX `verification_requests_identifier_token_key`(`identifier`, `token`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
